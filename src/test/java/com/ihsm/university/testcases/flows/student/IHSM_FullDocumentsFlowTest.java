...
public class IHSM_FullDocumentsFlowTest extends BaseClass {
    ...
    private void fillOtherDocuments() {
        ...
        new Documents_OtherDocuments(getDriver())
            .fillOtherDocumentsForm(
    ...
    private void fillIdentificationCard() {
        ...
        new Documents_IdentificationCard(getDriver())
            .fillIdentificationCardDetails(
                StudentFullRegistrationDataVariables.idNumber,
                StudentFullRegistrationDataVariables.idCountry,
                StudentFullRegistrationDataVariables.idIssueDate,
                StudentFullRegistrationDataVariables.idExpiryDate,
    ...
    private void fillVisaOffline() {
        ...
        new Documents_VisaInfo_OffVisa(getDriver())
            .fillVisaInfoOffVisaForm(
                StudentFullRegistrationDataVariables.visaType,
                StudentFullRegistrationDataVariables.visaPlaceOfIssue,
                StudentFullRegistrationDataVariables.visaIssueDate,
                StudentFullRegistrationDataVariables.visaStartDate,
                StudentFullRegistrationDataVariables.visaEndDate,
                StudentFullRegistrationDataVariables.visaRenewDate,
                StudentFullRegistrationDataVariables.visaNumber,
                StudentFullRegistrationDataVariables.visaCountry,
    ...
    private void fillVisaOnline() {
        ...
        new Documents_VisaInfo_OnVisa(getDriver())
            .fillOnlineVisaInfo(
    ...
    private void fillVisaRegister() {
        ...
        new Documents_VisaInfo_Register(getDriver())
            .fillRegisterInfo(
    ...
    private void fillPassportLocation() {
        ...
        new Documents_VisaInfo_PassportLocation(getDriver())
            .fillPassportLocationInfo(
    ...
    private void fillPassportInfo() {
        ...
        new Documents_PassportInformation(getDriver())
