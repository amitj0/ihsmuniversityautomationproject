...
public class BasicInfo_EnrollnmentInformation extends BasePage {
	...
	public BasicInfo_EnrollnmentInformation fillEnrollmentInformation(String addmissionBatch, String universityCurr, String semester, String group,
			String pinNo, String firstName, String middleName, String lastName, String gender, String dob,
			String nationality, String state, String mobileNo, String email, String address) {
		studentMenuItems();
		addNewStudent();
		addEnrollBtn();
